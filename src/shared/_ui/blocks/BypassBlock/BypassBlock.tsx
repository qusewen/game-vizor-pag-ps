  ...
  return (
    <div>
      <div className='container mx-auto flex max-w-[1100px] flex-col items-center pb-[75px] lg:flex-row'>
        <div className='w-[335px] pt-[24px] text-center text-[20px] leading-10 lg:mr-[110px] lg:w-[360px] lg:min-w-[360px] lg:pt-[44px] lg:text-left	lg:text-[27px]'>
          Больше не нужно придумывать как обойти блокировку и оформить подписку
        </div>
        <div className='relative flex flex-col  gap-5 pt-[25px] lg:flex-row lg:pt-[75px]'>
          <div className='flex w-[290px]  flex-col items-center rounded-[20px] bg-[#F1EEEE] px-2 pb-[25px] pt-[20px] lg:pb-[4px] lg:pt-[42px]'>
            <img
              alt='gamepad'
              src={gamepad.src}
            />
            <p className='mt-[20px] text-center lg:mt-[40px]'>Играй в бесплатные 600+ игр по подписке уже сейчас</p>
          </div>
